...
keymap({ "n" }, "<C-d>", "10jzt", { noremap = true, desc = "scroll [d]own 10 lines and move the current line to the top of the window" })
keymap({ "n" }, "<C-u>", "10kzt", { noremap = true, desc = "scroll [u]p 10 lines and move the current line to the top of the window" })
